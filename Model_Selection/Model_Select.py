...
def main(dataset_path, target_col=None):
    ...
    if result['recommended_approach'] == 'ensemble':
        print(f"Recommended Approach: Ensemble of {' and '.join(result['ensemble_details']['models'])}")
        print(f"\nExplanation:\n{result['explanation']}")
    else:
...
if __name__ == "__main__":
    main("../datasets/energydata_complete.csv")
